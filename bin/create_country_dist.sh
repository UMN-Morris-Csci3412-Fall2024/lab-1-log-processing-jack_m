...
input_dir="$1"
output_file="$input_dir/country_dist.html"  # Set the output file to the input directory
...
./bin/wrap_contents.sh "$temp_file" "html_components/country_dist" "$output_file"
